...
This tool uses Graphviz for the generation of formula ASTs, hence you should first install Graphviz on your system following the instructions 
...
- Separation of LTLp formulae into triples of pure past, pure present and pure future formulae written using the booleans and the US connectives only, 
