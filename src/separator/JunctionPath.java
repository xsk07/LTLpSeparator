...
public class JunctionPath {
    ...
    public void printPath() {
        ...
        System.out.printf("< %s >", revS);
    }

    public boolean equals(JunctionPath j) {
    ...
    public static ArrayList<JunctionPath> junctionsList(BinaryFormula x, Collection<OperatorFormula> ys) {
    ...
    public void rewriteImmediateChild() {
        ...
        if(op.equals(AND)) x.setLoperand(new BinaryFormula(AND, new AtomicFormula(TRUE), c));
        if(op.equals(OR)) x.setRoperand(new BinaryFormula(OR, new AtomicFormula(FALSE), c));
    }
