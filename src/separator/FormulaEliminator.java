...
public abstract class FormulaEliminator {
    ...
    /** E2 = A&(aS(q&B)) */
    private static BinaryFormula e1_E2(ArrayList<Formula> fms, Operator op){
    ...
    /** E3 = (A & q & aSB & aSq )Sq */
    private static BinaryFormula e1_E3(ArrayList<Formula> fms, Operator op){
    ...
    /** E1 = (a S (q & !A)) & !A & !(AUB) */
    private static BinaryFormula e2_E1(ArrayList<Formula> fms, Operator op){
    ...
    /** E2 = !A & !B & (aS(!A&q)) */
    private static BinaryFormula e2_E2(ArrayList<Formula> fms, Operator op){
    ...
    /** E3 = (!A & !B & q & (aS(!A&q))) S q */
    private static BinaryFormula e2_E3(ArrayList<Formula> fms, Operator op){
    ...
    /** E1 = (aSB) & (A|(B&(AUB)) */
    private static BinaryFormula e5_E1(ArrayList<Formula> fms, Operator op){
    ...
    /** E2 = ((A & (aSB)) S !b0) & d */
    private static BinaryFormula e5_E2(ArrayList<Formula> fms, Operator op){
    ...
    /** E3 = ((A & (aSB)) S !b0) & !d & (!q S !A) */
    private static BinaryFormula e5_E3(ArrayList<Formula> fms, Operator op){
    ...
    /** E1 = (a S (!A & q)) & (!A & !B) */
    private static BinaryFormula e6_E1(ArrayList<Formula> fms, Operator op) {
        return new BinaryFormula(
                AND,
                subformulaPattern8(fms, op), //  a S (q & !A)
                subformulaPattern9(fms) // !A & !B
    ...
    private static BinaryFormula e6_E2(ArrayList<Formula> fms, Operator op){
    ...
    /** E3 = (a S (q & !A)) & !A & !(AUB) */
    private static BinaryFormula e6_E3(ArrayList<Formula> fms, Operator op){
    ...
    /** E1 = (A & (q|!(AUB)) & (aS(B&q))) S (q | !(AUB)) */
    private static BinaryFormula e7_E1(ArrayList<Formula> fms, Operator op){
    ...
    /** (aS(B&q)) & A */
    private static BinaryFormula e7_E2(ArrayList<Formula> fms, Operator op){
        // (aS(B&q)) & A
        return new BinaryFormula(
                AND,
                subformulaPattern14(fms, op), // aS(B&q)
    ...
    /** (aS(B&q)) & B & (AUB) */
    private static BinaryFormula e7_E3(ArrayList<Formula> fms, Operator op){
    ...
    public static BinaryFormula elimination8(ArrayList<Formula> fms, Operator op) {
        return new BinaryFormula(
                OR,
                cnv.convert(e8_E1(fms, op)), // !( !(!a|(AUB)) S true)
                new BinaryFormula(
                        OR,
    ...
    /** E1 = H(!a|(AUB)) */
    private static UnaryFormula e8_E1(ArrayList<Formula> fms, Operator op) {
    ...
    /** E2 =  (!q & (AUB) & !a) S (!a|(AUB)) */
    private static BinaryFormula e8_E2(ArrayList<Formula> fms, Operator op) {
    ...
    /** E3 = (!q&(AUB)) S (!a|(AUB))  */
    private static BinaryFormula e8_E3(ArrayList<Formula> fms, Operator op) {
